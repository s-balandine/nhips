...
%epic% import TXT "person.csv" "field interviewer.rec" delim=; q=all replace ignorefirst
%epic% import TXT "person.csv" "field supervisor.rec"  delim=; q=all replace ignorefirst
